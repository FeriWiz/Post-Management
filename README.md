...
نحوه ی لاگین کردن:
اول رجیستر کنید و توکن بازگردانده شده را کپی کنید.
 سپس در سمت راست بالا روی گزینه ی Authorize بزنید و در فیلد داده شده ، عبارت Bearer را بنویسید 
 و سپس با یک space ، توکن کپی شده را پیست کنید و روی Authorize بزنید 
